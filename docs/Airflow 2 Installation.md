...
keeyong/data-engineering-batch7 repository에 있는 dags 폴더의 내용을 /var/lib/airflow/dags로 복사한다. 

```
sudo su airflow
cd ~/
git clone https://github.com/keeyong/data-engineering-batch7.git
cp -r data-engineering-batch7/dags/* dags
```
